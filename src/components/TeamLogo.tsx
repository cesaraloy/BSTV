...
export const teamLogos: Record<string, string> = {
  ...
  'Athletic Club':          WP('Athletic_Club_logo.svg'),
  ...
  'RCD Mallorca':           WP('RCD_Mallorca_logo.svg'),
  'Mallorca':               WP('RCD_Mallorca_logo.svg'),
  ...
  'FC Andorra':             WP('FC_Andorra_logo.svg'),
  ...
  'Brentford':              WP('Brentford_FC_crest.svg'),
  ...
  'Nottingham Forest':      WP('Nottingham_Forest_FC_logo.svg'),
  ...
  'Eintracht Frankfurt':    WP('Eintracht_Frankfurt_Logo.svg'),
  'Fenerbahçe':             WP('Fenerbahce_SK.svg'),
  'Galatasaray':            WP('Galatasaray_SK.svg'),
  ...
  'Olympique de Marseille': WP('Olympique_de_Marseille_logo.svg'),
  'Marseille':              WP('Olympique_de_Marseille_logo.svg'),
  ...
  'Feyenoord':              WP('Feyenoord_logo.svg'),
  // ── Women's CL extra ─────────────────────────────────────────────
